...
const languageRequirementSchema = z
        .object({
                languageCode: z
                        ...
                        .transform(value => value.toUpperCase()),
                proficiency: z
                        .nativeEnum(LanguageProficiency)
...
export const JobPostFilterSchema = z
        .object({
                ...
                search: z
                        ...
                        .optional(),
                statuses: z
                        .preprocess(parseStringArray, z.array(z.nativeEnum(JobStatus)).optional())
                        .optional(),
                paymentModes: z
                        .preprocess(parseStringArray, z.array(z.nativeEnum(JobPaymentMode)).optional())
                        .optional(),
                experienceLevels: z
                        .preprocess(parseStringArray, z.array(z.nativeEnum(JobExperienceLevel)).optional())
                        .optional(),
                locationTypes: z
                        .preprocess(parseStringArray, z.array(z.nativeEnum(JobLocationType)).optional())
                        .optional(),
                visibility: z
                ...
                languageCodes: z
                        .preprocess(parseStringArray, z.array(z.string().min(2).max(10)).optional())
                        .optional(),
                skillIds: z
                        .preprocess(parseStringArray, z.array(z.string().min(1)).optional())
                        .optional(),
