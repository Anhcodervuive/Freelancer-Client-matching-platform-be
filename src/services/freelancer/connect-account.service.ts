...
const CLIENT_BUSINESS_PROFILE_URL =
        ...
        !isLocalHostname(parsedClientUrl.hostname)
                ? CLIENT_BASE_URL
                : undefined

const DEFAULT_RETURN_URL = CLIENT_BASE_URL
        ? `${CLIENT_BASE_URL}/settings/payouts`
        : undefined
const DEFAULT_REFRESH_URL = CLIENT_BASE_URL
        ? `${CLIENT_BASE_URL}/settings/payouts/refresh`
        : undefined
