...
console.log('3. Nếu DocuSign cảnh báo redirect URI chưa được đăng ký, vào Apps & Keys → Integration Key → Additional settings → Redirect URIs và thêm URL trong biến DOCUSIGN_CONSENT_REDIRECT_URI, sau đó thử lại.')
